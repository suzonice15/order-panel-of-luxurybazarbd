...
@section('main',"SteadFast Booking")
@section('active',"SteadFast Booking")
@section('title',"SteadFast Booking")
@section('main-content')
    ...
    <div class="container" style="background:#fff;margin-bottom: 9px;">
       <form action="{{url('/')}}/admin/productBookingToSteadFast" method="get" >
        <div class="row">
    ...
    <script>
        ...
        $("#send").click(function () {
            ...
            if (order_id.length > 0) {
                ...
                $.ajax({
                    url: '{{url('/')}}/admin/productBookingToSteadFast',
                    data: {
                        order_id: order_id,
                        "_token": "{{csrf_token()}}"
                    },
